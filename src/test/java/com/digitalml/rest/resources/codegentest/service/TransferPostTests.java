...
public class TransferPostTests {

	@Test
	public void testOperationTransferPostBasicMapping()  {
		MoneySendServiceDefaultImpl serviceDefaultImpl = new MoneySendServiceDefaultImpl();
		TransferPostInputParametersDTO inputs = new TransferPostInputParametersDTO();
		inputs.setPaymentRequestV3(null);
		TransferPostReturnDTO returnValue = serviceDefaultImpl.transferPost(fullyAutheticatedSecurityContext, inputs);
		
		assertNotNull(returnValue);
		assertNotNull(returnValue.getResponseWrapper200TransferPost());				
	}
