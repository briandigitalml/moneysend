...
/*
JSON Representation for Transaction_36:
{
  "type": "object",
  "properties": {
    "Type": {
      "description": "Type of transaction. Details- AlphaNumeric. Valid Values- FUNDINGREVERSAL, PAYMENT REVERSAL",
      "type": "string"
    },
    ...
    "NetworkReferenceNumber": {
      "description": "Network Reference Number that can be used for transaction inquiry. Details- Numeric, 9 in length, value is unique identifier.",
      "type": "string"
    },
    "SettlementDate": {
...
public class Transaction_36 {
	...
	@Size(max=1)
	private com.digitalml.rest.resources.codegentest.Response_37 response;
...
@ApiModelProperty(notes = "Type of transaction. Details- AlphaNumeric. Valid Values- FUNDINGREVERSAL, PAYMENT REVERSAL")
...
@ApiModelProperty(notes = "Network Reference Number that can be used for transaction inquiry. Details- Numeric, 9 in length, value is unique identifier.")
...
@ApiModelProperty(notes = "Date Funds will be transferred between the acquirer and issuer by Single Message System. Transaction settlement date. Details- Numeric, 4 in length, format MMDD.")
	...
	public com.digitalml.rest.resources.codegentest.Response_37 getResponse() {
		return response;
	}
	
	public void setResponse(com.digitalml.rest.resources.codegentest.Response_37 response) {
