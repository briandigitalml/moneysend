...
/*
JSON Representation for Transaction_16:
{
  "type": "object",
  "properties": {
    "Type": {
...
public class Transaction_16 {
	...
	@Size(max=1)
	private com.digitalml.rest.resources.codegentest.Response_17 response;
...
@ApiModelProperty(notes = "Date Funds will be transferred between the acquirer and issuer by Single Message System. Transaction settlement date. Details- Numeric, 4 in length, format MMDD.")
	...
	public com.digitalml.rest.resources.codegentest.Response_17 getResponse() {
		return response;
	}
	
	public void setResponse(com.digitalml.rest.resources.codegentest.Response_17 response) {
