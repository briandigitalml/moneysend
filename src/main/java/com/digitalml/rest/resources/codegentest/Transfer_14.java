...
/*
JSON Representation for Transfer_14:
{
  "type": "object",
  "properties": {
    "RequestId": {
...
public class Transfer_14 {
	...
	@Size(max=1)
	private com.digitalml.rest.resources.codegentest.Transactionhistory_15 transactionHistory;
...
@ApiModelProperty(notes = "This is the Unique identifier for the entire MoneySend Transfer provided in the request. Details-  alphanumeric, 19")
	...
	public com.digitalml.rest.resources.codegentest.Transactionhistory_15 getTransactionHistory() {
		return transactionHistory;
	}
	
	public void setTransactionHistory(com.digitalml.rest.resources.codegentest.Transactionhistory_15 transactionHistory) {
